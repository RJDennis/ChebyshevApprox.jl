...
av = CApproxPlan(hv, order, dom)
al = CApproxPlan(hl, order, dom)
...
bv = CApproxPlanPoly((pv,), order, dom)
bl = CApproxPlanPoly((pl,), order, dom)
...
bv = CApproxPlanPoly((pv_1, pv_2), ord, dom)
bl = CApproxPlanPoly((pl_1, pl_2), ord, dom)
