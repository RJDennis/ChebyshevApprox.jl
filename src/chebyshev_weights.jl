...
function chebyshev_weights(cheb::ChebInterp)

  weights = chebyshev_weights(cheb.data,cheb.nodes,cheb.order,cheb.domain)
...
function chebyshev_weights_threaded(cheb::ChebInterp)
